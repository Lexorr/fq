    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <form onSubmit={handleSubmitTransaction} className="bg-white shadow-md rounded-xl p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="recipient" className="block text-sm font-medium text-emerald-600">
          ...
          <div>
            <label htmlFor="amount" className="block text-sm font-medium text-emerald-600">
              Amount
            </label>
            <input
              id="amount"
        ...
        <div className="flex justify-between">
          ...
          <button
            type="submit"
            className="w-32 py-2 bg-green-600 text-white rounded-md hover:bg-emerald-600"
          >
            Confirm Transaction
          </button>
        </div>
