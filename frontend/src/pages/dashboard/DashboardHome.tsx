  ...
  return (
    <div>
      ...
      <div>
        <div>
          {isAdmin && (
            <div className="mt-12  p-4 rounded shadow w-full flex flex-col items-center gap-2">
              <h2 className="text-lg text-emerald-600 capitalize font-semibold mb-2">
                Update Interest for a User
              </h2>
              <input
                type="text"
              ...
              <button
                ...
                className="px-4 py-2 bg-emerald-600 w-full text-white rounded hover:bg-emerald-700"
              >
                Add 20% Interest
              </button>
