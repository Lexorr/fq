    ...
    <div className="overflow-x-hidden w-full px-4 sm:px-6 lg:px-8 py-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center max-w-7xl mx-auto">
        ...
        <div className="flex flex-col justify-center items-center md:items-start">
          ...
          <Link to="/about">
            <button className="py-3 px-6 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-2xl mt-6 transition duration-300 ease-in-out transform hover:scale-105">
              Read More
            </button>
          </Link>
