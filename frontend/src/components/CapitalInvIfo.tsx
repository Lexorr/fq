      ...
      <div className="bg-white py-16 px-6 md:px-20">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mt-2 mb-6">
            Welcome to Lexor Ventures
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed">
            Lexor Ventures is a trusted investment company focused on helping individuals and businesses grow their financial potential. With years of industry experience, innovative strategies, and a commitment to excellence, we empower our clients to make smarter investment choices and build sustainable wealth.
          </p>
        </div>
